...
corr_long_p |>
  ...
  mutate(
    rep1 = case_when(
      grepl('adult_', rep1) ~ paste0('microglia_', 
                                   stringr::str_split(rep1, '_', simplify = TRUE)[, 3]),
      TRUE ~ rep1),
    rep2 = case_when(
      grepl('adult_', rep2) ~ paste0('microglia_', 
                                   stringr::str_split(rep2, '_', simplify = TRUE)[, 3]),
      TRUE ~ rep2),) |>
